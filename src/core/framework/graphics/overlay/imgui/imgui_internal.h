...
struct IMGUI_API ImDrawListSharedData
{
    ...
    void AddSubtractedRect(ImDrawList* draw_list, const ImVec2& outer_min, const ImVec2& outer_max, const ImVec2& uv_min, const ImVec2& uv_max, const ImVec2* inner_points, int inner_points_count, ImU32 col);
};
